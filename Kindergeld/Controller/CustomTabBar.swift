...
class CustomTabBar: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let bar1 = createTabBarController(vc: FormVC(), title: "Formulár",image: #imageLiteral(resourceName: "edit"))
        let bar2 = createTabBarController(vc: PayDaysVC(), title: "Výplatné termíny",image: #imageLiteral(resourceName: "calendar"))
        let bar3 = createTabBarController(vc: InfoVC(), title: "Informácie",image: #imageLiteral(resourceName: "help-circle"))
